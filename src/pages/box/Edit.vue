    ...
    <div class="container border p-3">
      ...
      <form class="mx-auto" @submit.prevent="handle()">
        ...
        <div class="row">
          <div class="col">
            <label class="form-control-label"
              >Phương tiện: <b class="text-danger">*</b></label
            >
            <input
              type="text"
              name="name"
          ...
          <div class="col">
            <label class="form-control-label"
              >Số người: <b class="text-danger">*</b></label
            >
            <input
              type="number"
              name="name"
        ...
        <div class="form-group">
          <label class="form-control-label"
            >Địa điểm: <b class="text-danger">*</b></label
          >
        ...
        <div class="row">
          <div class="col">
            <label class="form-control-label"
              >Ngày bắt đầu: <b class="text-danger">*</b></label
            >
            <input
              type="date"
              name="name"
          ...
          <div class="col">
            <label class="form-control-label"
              >Ngày kết thúc: <b class="text-danger">*</b></label
            >
            <input
              type="date"
              name="name"
        ...
        <div class="d-flex align-items-center">
          <button type="submit" class="mt-2 btn btn-info">Cập nhật lại</button>
        </div>
      </form>
    </div>
    <Footer />
...
export default {
  ...
  methods: {
    ...
    handle() {
      ...
      if (this.box.image) data.append("image", this.box.image);
      ...
      axios
        .post(`box/${this.box.id}`, data, config)
        .then((response) => {
